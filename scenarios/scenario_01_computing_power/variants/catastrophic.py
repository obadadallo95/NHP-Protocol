"""
Scenario 01 — Computing Power: Catastrophic Variant
3% device uptime — worst-case scenario.
"""
...
def run(
    ...
    uptime: float = config.UPTIME_CATASTROPHIC,
) -> Dict[str, Any]:
    """Calculate H100-equivalent computing power at catastrophic uptime.
