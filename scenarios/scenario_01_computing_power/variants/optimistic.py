"""
Scenario 01 — Computing Power: Optimistic Variant
40% device uptime — viral adoption with high engagement.
"""
...
def run(
    ...
    uptime: float = config.UPTIME_OPTIMISTIC,
) -> Dict[str, Any]:
    """Calculate H100-equivalent computing power at optimistic uptime.
