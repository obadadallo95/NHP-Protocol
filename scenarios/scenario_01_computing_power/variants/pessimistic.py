"""
Scenario 01 — Computing Power: Moderate Variant
25% device uptime — steady organic adoption.
"""
...
def run(
    ...
    uptime: float = config.UPTIME_MODERATE,
) -> Dict[str, Any]:
    """Calculate H100-equivalent computing power at moderate uptime.
