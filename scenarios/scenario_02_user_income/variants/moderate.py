"""
Scenario 02 — User Income: Moderate Variant
$0.20/GPU-hour token price — balanced market pricing.
"""
...
def run(
    ...
    token_price: float = config.TOKEN_PRICE_MODERATE,
) -> Dict[str, Any]:
    """Calculate user monthly/annual net income at moderate token price.
