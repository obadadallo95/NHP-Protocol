"""
Scenario 02 — User Income: Optimistic Variant
$0.50/GPU-hour token price — premium market pricing.
"""
...
def run(
    ...
    token_price: float = config.TOKEN_PRICE_OPTIMISTIC,
) -> Dict[str, Any]:
    """Calculate user monthly/annual net income at optimistic token price.
