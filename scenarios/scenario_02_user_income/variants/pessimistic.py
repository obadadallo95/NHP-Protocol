"""
Scenario 02 — User Income: Pessimistic Variant
$0.08/GPU-hour token price — depressed market pricing.
"""
...
def run(
    ...
    token_price: float = config.TOKEN_PRICE_PESSIMISTIC,
) -> Dict[str, Any]:
    """Calculate user monthly/annual net income at pessimistic token price.
