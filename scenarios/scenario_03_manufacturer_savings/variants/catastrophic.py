"""
Scenario 03 — Manufacturer Savings: Catastrophic Variant
NHP covers 5% of Galaxy AI requests.
"""
...
def run(
    ...
    coverage: float = config.COVERAGE_CATASTROPHIC,
) -> Dict[str, Any]:
    """Calculate manufacturer savings when NHP covers 5% of AI requests.
