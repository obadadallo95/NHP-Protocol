"""
Scenario 03 — Manufacturer Savings: Optimistic Variant
NHP covers 70% of Galaxy AI requests.
"""
...
def run(
    ...
    coverage: float = config.COVERAGE_OPTIMISTIC,
) -> Dict[str, Any]:
    """Calculate manufacturer savings when NHP covers 70% of AI requests.
