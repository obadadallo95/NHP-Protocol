"""
Scenario 03 — Manufacturer Savings: Pessimistic Variant
NHP covers 15% of Galaxy AI requests.
"""
...
def run(
    ...
    coverage: float = config.COVERAGE_PESSIMISTIC,
) -> Dict[str, Any]:
    """Calculate manufacturer savings when NHP covers 15% of AI requests.
