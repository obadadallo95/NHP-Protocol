"""
Scenario 05 — Environmental Impact: Catastrophic Variant
NHP replaces 0.5 data centers.
"""
...
def run(
    ...
    replaced: float = config.REPLACED_DC_CATASTROPHIC,
    co2_per_car: float = config.CO2_PER_CAR_TONS_YEAR,
) -> Dict[str, Any]:
    """Calculate CO2 savings from replacing 0.5 data centers.
