"""
Scenario 05 — Environmental Impact: Moderate Variant
NHP replaces 5 large data centers.
"""
...
def run(
    ...
    replaced: float = config.REPLACED_DC_MODERATE,
    co2_per_car: float = config.CO2_PER_CAR_TONS_YEAR,
) -> Dict[str, Any]:
    """Calculate CO2 savings from replacing 5 data centers.
