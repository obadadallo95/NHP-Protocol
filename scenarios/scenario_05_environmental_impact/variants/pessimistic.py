"""
Scenario 05 — Environmental Impact: Pessimistic Variant
NHP replaces 2 large data centers.
"""
...
def run(
    ...
    replaced: float = config.REPLACED_DC_PESSIMISTIC,
    co2_per_car: float = config.CO2_PER_CAR_TONS_YEAR,
) -> Dict[str, Any]:
    """Calculate CO2 savings from replacing 2 data centers.
